...
(function (root, factory) {
  ...
  // [name, category, low, high] — typical value range in dollars for one item in good used condition or better.
  const RAW = [
    ['Shirt or blouse', 'Clothing', 2.5, 12], ['T-shirt', 'Clothing', 1, 6], ['Sweater', 'Clothing', 3.75, 15], ['Sweatshirt or hoodie', 'Clothing', 3, 12],
    ['Pants or jeans', 'Clothing', 3.5, 12], ['Shorts', 'Clothing', 2, 8], ['Dress', 'Clothing', 4, 20], ['Skirt', 'Clothing', 3, 8],
    ...
    ['Sofa', 'Furniture', 35, 200], ['Loveseat', 'Furniture', 25, 150], ['Upholstered chair', 'Furniture', 25, 100], ['Recliner', 'Furniture', 25, 150],
    ...
    ['Flat-screen TV', 'Electronics', 75, 225], ['Computer or laptop (working)', 'Electronics', 50, 300], ['Computer monitor', 'Electronics', 10, 60], ['Printer', 'Electronics', 5, 75],
    ...
    ['Board game or puzzle', 'Toys & sports', 1, 5], ['Toy', 'Toys & sports', 0.5, 5], ['Stuffed animal', 'Toys & sports', 0.5, 3], ['Bicycle', 'Toys & sports', 5, 80], ['Golf clubs (set)', 'Toys & sports', 25, 150],
  ...
  const CATALOG = RAW.map(([name, category, low, high], i) => ({ id: 'v' + i, name, category, low, high }));
  ...
  function byName(name) { const n = norm(name); return CATALOG.find((c) => norm(c.name) === n) || null; }
