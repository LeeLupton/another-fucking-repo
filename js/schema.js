  ...
  const SECTIONS = [
    {
      ...
      lines: [
        ...
        { id: 'med.ltc', label: 'Long-term Care Insurance', hint: 'Deductible only up to an annual limit that depends on your age at the end of the year. This worksheet counts the whole premium, so tell your preparer your age and let them apply the limit.', keywords: ['long-term care', 'long term care', 'ltc', 'ltci', 'genworth', 'fltcip'] },
