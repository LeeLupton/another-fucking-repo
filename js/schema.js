  ...
  const SECTIONS = [
    {
      ...
      lines: [
        ...
        { id: 'med.ltc', label: 'Long-term Care Insurance', hint: 'Deductible only up to an annual limit set by your age at the end of the year. There are five age bands, and the limit belongs to each insured person, so on a joint return each spouse\'s policy has its own. Set your age band in Settings, and your spouse\'s band too, and this worksheet applies each limit; if a policy insures anyone else, tell your preparer so it gets its own.', keywords: ['long-term care', 'long term care', 'ltc', 'ltci', 'genworth', 'fltcip'] },
    ...
    },
    {
      ...
      lines: [
        ...
        { id: 'int.investment', label: 'Investment Interest', hint: 'Interest on money borrowed to buy taxable investments (margin interest). It is deductible only up to your net investment income for the year, and the rest carries forward — Form 4952. Enter your net investment income in Settings and this worksheet applies the limit; until then it counts the whole amount.', keywords: ['margin interest', 'investment interest', 'brokerage interest', 'margin loan', 'schwab margin', 'fidelity margin', 'interactive brokers interest', 'form 4952', 'robinhood margin', 'etrade margin'] },
      ],
    },
    {
      id: 'other',
