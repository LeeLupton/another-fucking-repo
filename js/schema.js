...
(function (root, factory) {
  ...
  const SECTIONS = [
    {
      ...
      lines: [
        { id: 'med.doctor', label: 'Doctor', keywords: ['doctor', 'dr', 'physician', 'copay', 'copays', 'co-pay', 'co-pays', 'copayment', 'coinsurance', 'co-insurance', 'clinic', 'office visit', 'urgent care', 'pediatrician', 'dermatologist', 'cardiologist', 'specialist', 'checkup', 'check-up', 'telehealth', 'primary care', 'pcp', 'family practice', 'obgyn', 'ob/gyn', 'allergist', 'podiatrist', 'gp'] },
        ...
        { id: 'med.hospital', label: 'Hospital & Emergency', keywords: ['hospital', 'emergency', 'emergency room', 'er visit', 'er', 'inpatient', 'hospital admission', 'trauma'] },
        ...
        { id: 'med.dental', label: 'Dental', keywords: ['dentist', 'dental', 'teeth cleaning', 'filling', 'crown', 'root canal', 'oral surgeon', 'periodontist', 'extraction', 'fluoride', 'implant', 'aspen dental', 'dds', 'dmd', 'dentistry', 'family dentistry'] },
        ...
        { id: 'med.glasses', label: 'Glasses & Contact Lenses', keywords: ['glasses', 'eyeglasses', 'contact lens', 'contact lenses', 'contacts', 'optometrist', 'ophthalmologist', 'eye exam', 'eye doctor', 'lenscrafters', 'warby parker', '1-800 contacts', 'frames', 'lenses', 'lasik', 'america\'s best', 'visionworks', 'pearle', 'optical', 'vision center', 'eyecare', 'eye care', 'optometry'] },
    ...
    },
    {
      ...
      lines: [
        ...
        { id: 'se.office', label: 'Office Expenses', keywords: ['office', 'printer', 'ink', 'toner', 'printer paper', 'copy paper', 'staples', 'office depot', 'officemax', 'pens', 'postage', 'stamps', 'usps', 'shipping', 'ups store', 'fedex', 'quickbooks', 'software subscription', 'adobe', 'microsoft 365', 'office 365', 'zoom', 'dropbox', 'google workspace', 'envelopes', 'canva', 'notion', 'slack'] },
    ...
    },
    {
      ...
      lines: [
        ...
        { id: 'tax.state_income', label: 'State Income Tax', hint: 'Estimated payments made during the year, plus any balance due on last year\'s state return paid this year. Withholding from pay is already on your W-2.', keywords: ['state income tax', 'state tax', 'state taxes', 'state estimated tax', 'state estimated payment', 'state estimated payments', 'state quarterly', 'department of revenue', 'dept of revenue', 'dor', 'comptroller', 'franchise tax board', 'ftb', 'state balance due', 'state estimated', 'local income tax', 'city income tax', 'school district income tax', 'rita', 'state extension payment'] },
      ],
    },
    {
      id: 'interest',
  ...
  const NON_DEDUCTIBLE = [
    ...
    { words: ['hoa', 'hoa dues', 'homeowners association', 'homeowner\'s insurance', 'homeowners insurance', 'renters insurance'], reason: 'HOA dues and homeowner\'s or renter\'s insurance are not deductible for a personal residence.' },
    ...
    { words: ['car loan interest', 'auto loan interest', 'car loan', 'auto loan', 'personal loan interest', 'personal loan', 'credit card interest'], reason: 'Interest on personal car loans, credit cards, and personal loans is not deductible. Interest on a vehicle used for your business belongs under Car & Trucking Expenses.', suppress: ['edu.loan_interest'] },
    ...
    { words: ['netflix', 'spotify', 'hulu', 'disney+', 'amazon prime', 'costco membership', 'sam\'s club membership', 'house cleaning', 'maid service'], reason: 'Personal subscriptions, memberships, and household services are not deductible.' },
