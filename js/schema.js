  ...
  const SECTIONS = [
    {
      ...
      lines: [
        ...
        { id: 'med.ltc', label: 'Long-term Care Insurance', hint: 'Deductible only up to an annual limit set by your age at the end of the year. There are five age bands, and the limit belongs to each insured person, so on a joint return each spouse\'s policy has its own. Set your age band in Settings and this worksheet applies your limit; if a second policy insures someone in another band, tell your preparer so each policy gets its own.', keywords: ['long-term care', 'long term care', 'ltc', 'ltci', 'genworth', 'fltcip'] },
